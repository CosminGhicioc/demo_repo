...
public class LightTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("After turn on state is " + bulb1.getIsOn());

		bulb1.brighten();

		System.out.println("After brigthen intensity is " + bulb1.getIntensity());
		System.out.println("After brighten state is " + bulb1.getIsOn());

		bulb1.dim();

		System.out.println("After dim intensity is " + bulb1.getIntensity());
		System.out.println("After dim state is " + bulb1.getIsOn());

		bulb1.turnOff();

		System.out.println("After turn off intensity is " + bulb1.getIntensity());
		System.out.println("After turn off state is " + bulb1.getIsOn());

		bulb1.turnOn();

		System.out.println("After turn on (again) intensity is " + bulb1.getIntensity());
		System.out.println("After turn on (again) state is " + bulb1.getIsOn());
